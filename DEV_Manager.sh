...
ADDNODE2=45.32.150.157:22618
ADDNODE3=185.92.221.156:22618
ADDNODE4=35.187.229.31:22618
ADDNODE5=94.177.254.36:22618
COINPORT=22618
COINRPCPORT=12345
...
Deviant_Logo(){
  ...
  echo "                                                                      ";
  echo -e "      ${GREEN}                                                                ";
  echo "  ______   _______          _________ _______  _       _________";
  echo " (  __  \ (  ____ \|\     /|\__   __/(  ___  )( (    /|\__   __/";
  echo " | (  \  )| (    \/| )   ( |   ) (   | (   ) ||  \  ( |   ) (   ";
  echo " | |   ) || (__    | |   | |   | |   | (___) ||   \ | |   | |   ";
  echo " | |   | ||  __)   ( (   ) )   | |   |  ___  || (\ \) |   | |   ";
  echo " | |   ) || (       \ \_/ /    | |   | (   ) || | \   |   | |   ";
  echo " | (__/  )| (____/\  \   /  ___) (___| )   ( || )  \  |   | |   ";
  echo " (______/ (_______/   \_/   \_______/|/     \||/    )_)   )_(   ";
  echo "                                                               ";
    echo -e "${RED}                                                           ";
  echo -e "     ╔╦╗┌─┐┌─┐┌┬┐┌─┐┬─┐┌┐┌┌─┐┌┬┐┌─┐  ╔╦╗┌─┐┌┐┌┌─┐┌─┐┌─┐┬─┐ ";
  echo -e "     ║║║├─┤└─┐ │ ├┤ ├┬┘││││ │ ││├┤   ║║║├─┤│││├─┤│ ┬├┤ ├┬┘";
