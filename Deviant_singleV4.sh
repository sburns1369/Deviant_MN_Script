...
echo
echo
echo -e ${GREEN}"Are you sure you want to continue the installation of a Deviant Masternode?"
...
echo -e "${GREEN}Configuring Deviant Node${CLEAR}"
...
echo "externalip=$(hostname -I | cut -f1 -d' '):2219" >> /home/deviant1/.deviant/deviant.conf
...
echo
echo -e ${YELLOW}"Launching DEV Node"${CLEAR}
...
echo
echo -e ${BOLD}"Your DEV Node has Launched."${CLEAR}
echo

echo -e "${GREEN}You can check the status of your DEV Masternode with"${CLEAR}
echo -e "${YELLOW} deviant-cli -datadir=/home/deviant1/.deviant masternode status"${CLEAR}
