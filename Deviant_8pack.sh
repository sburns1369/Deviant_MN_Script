...
if id "deviant8" >/dev/null 2>&1; then
echo -e ${YELLOW} "Found user deviant8!"${CLEAR}
MN8=1
else
sudo adduser --system --home /home/deviant8 deviant8
MN8=0
fi
echo
echo
...
echo "externalip=[${MNIP4}]:2219" >> /home/deviant4/deviant.conf
...
echo "externalip=[${MNIP5}]:2219" >> /home/deviant5/deviant.conf
...
echo "externalip=[${MNIP6}]:2219" >> /home/deviant6/deviant.conf
...
echo "externalip=[${MNIP7}]:2219" >> /home/deviant7/deviant.conf
...
echo
if [ ! -f /home/deviant8/.deviant/deviant.conf ]; then
if [ ! -f /home/deviant8/deviant.conf ]; then
echo -e "${GREEN}Eigth Deviant Node Configuration Not Found....${CLEAR}"
echo -e "${YELLOW}Configuring Eigth Deviant Node${CLEAR}"
sudo mkdir /home/deviant8/.deviant
sudo touch /home/deviant8/deviant.conf
echo "rpcuser=user"`shuf -i 100000-9999999 -n 1` >> /home/deviant8/deviant.conf
echo "rpcpassword=pass"`shuf -i 100000-9999999 -n 1` >> /home/deviant8/deviant.conf
echo "rpcallowip=127.0.0.1" >> /home/deviant8/deviant.conf
echo "server=1" >> /home/deviant8/deviant.conf
echo "daemon=1" >> /home/deviant8/deviant.conf
echo "maxconnections=250" >> /home/deviant8/deviant.conf
echo "masternode=1" >> /home/deviant8/deviant.conf
echo "rpcport=29029" >> /home/deviant8/deviant.conf
echo "listen=0" >> /home/deviant8/deviant.conf
echo "externalip=[${MNIP8}]:2219" >> /home/deviant8/deviant.conf
echo "masternodeprivkey=$MNKEY8" >> /home/deviant8/deviant.conf
if [[ $NULLREC = "y" ]] ; then
echo "masterNode8 : true" >> /usr/local/nullentrydev/dev.log
echo "walletVersion8 : 4.0.0.0" >> /usr/local/nullentrydev/dev.log
echo "scriptVersion8 : 0.99" >> /usr/local/nullentrydev/dev.log
fi
else
echo
echo -e ${YELLOW}"Found /home/deviant8/deviant.conf"${CLEAR}
echo -e ${YELLOW}"Skipping Pre-stage for Eigth Node "${CLEAR}
MN8=0
fi
else
echo -e ${YELLOW}"Found /home/deviant8/.deviant/deviant.conf"${CLEAR}
...
if [[ "$MN8" -eq "0" ]]; then
sudo cp -r /home/deviant1/.deviant/* /home/deviant8/.deviant
rm /home/deviant8/.deviant/deviant.conf
cp -r /home/deviant8/deviant.conf /home/deviant8/.deviant/deviant.conf
sleep 1
fi
echo -e ${YELLOW}"Launching First DEV Node"${CLEAR}
deviantd -datadir=/home/deviant1/.deviant -daemon
...
sleep 20
echo -e ${YELLOW}"Launching Eigth DEV Node"${CLEAR}
deviantd -datadir=/home/deviant8/.deviant -daemon
sleep 20
...
echo -e "${YELLOW}For mn8: \"deviant-cli -datadir=/home/deviant8/.deviant masternode status\""${CLEAR}
echo
